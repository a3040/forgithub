#src/icons/alt.svg 추가
#Toolbar.js에 img에 alt 속성 넣는것 추가 Line : 96~115

https://github.com/kensnyder/quill-image-resize-module 여기 clone 했습니다.


    <script src="//cdn.quilljs.com/1.3.6/quill.js"></script>
    <!-- Quill Image Resize 모듈 -->
    <script src="/js/image-resize.min.js"></script>

    1.3.6 버전에서 특이사항없이 동작했습니다.
